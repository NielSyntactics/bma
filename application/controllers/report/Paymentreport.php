...
class Paymentreport extends CI_Controller{
	...
	public function getMainSchoolYear(){
		$data['success'] = true;
		$data['view'] = $this->model->getMainSchoolYear();
	...
	public function viewReport( $print = false ){
		...
		foreach( $data as $rs ){
			...
			for( $i = 0; $i < 10; $i++ ){
				...
				if( $totPay < $perColumn && $totPay > 0 ){
					...
					/* Added By Stephen*/
				if($i == 0)$fTD +=  $perColumn -$totPay;
				else if($i == 1)$sTD +=  $perColumn -$totPay;
				else if($i == 1)$sTD +=  $perColumn -$totPay;
				else if($i == 2)$tTD += $perColumn -$totPay;
				else if($i == 3)$fourthTD +=  $perColumn -$totPay;
				else if($i == 4)$fifTD +=  $perColumn -$totPay;
				else if($i == 5)$sixTD +=  $perColumn -$totPay;
				else if($i == 6)$sevTD +=  $perColumn -$totPay;
				else if($i == 7)$eiTD +=  $perColumn -$totPay;
				else if($i == 8)$nineTD +=  $perColumn -$totPay;
				else if($i == 9)$TenTD +=  $perColumn -$totPay;
				$totPay = 0;
					...
					/* Added By Stephen*/
					if($i == 0)$fTD =  $fTD + $perColumn;
					else if($i == 1)$sTD =  $sTD + $perColumn;
					else if($i == 2)$tTD =  $tTD + $perColumn;
					else if($i == 3)$fourthTD =  $fourthTD + $perColumn;
					else if($i == 4)$fifTD=  $fifTD + $perColumn;
					else if($i == 5)$sixTD =  $sixTD + $perColumn;
					else if($i == 6)$sevTD =  $sevTD + $perColumn;
					else if($i == 7)$eiTD =  $eiTD + $perColumn;
					else if($i == 8)$nineTD =  $nineTD + $perColumn;
					else if($i == 9)$TenTD =  $TenTD + $perColumn;
		...
		if( $batchReceivableCategoryID == 1 ) {
			$view .= '<tr>
				<td colspan="6" style="border: #000 1px solid;" >&nbsp;<strong>Total Receivables</strong></td>
				<td style="border: #000 1px solid;text-align:right;">'.$fTD.'</td>
				<td style="border: #000 1px solid;text-align:right;">'.$sTD.'</td>
				<td style="border: #000 1px solid;text-align:right;">'.$tTD.'</td>
				<td style="border: #000 1px solid;text-align:right;">'.$fourthTD.'</td>
				<td style="border: #000 1px solid;text-align:right;">'.$fifTD.'</td>
				<td style="border: #000 1px solid;text-align:right;">'.$sixTD.'</td>
				<td style="border: #000 1px solid;text-align:right;">'.$sevTD.'</td>
				<td style="border: #000 1px solid;text-align:right;">'.$eiTD.'</td>
				<td style="border: #000 1px solid;text-align:right;">'.$nineTD.'</td>
				<td style="border: #000 1px solid;text-align:right;">'.$TenTD.'</td>
			</tr>';
		} else {
			$view .= '<tr>
				<td colspan="4" style="border: #000 1px solid;" >&nbsp;<strong>Total Receivables</strong></td>
				<td style="border: #000 1px solid;text-align:right;">'.$fTD.'</td>
				<td style="border: #000 1px solid;text-align:right;">'.$sTD.'</td>
				<td style="border: #000 1px solid;text-align:right;">'.$tTD.'</td>
				<td style="border: #000 1px solid;text-align:right;">'.$fourthTD.'</td>
