...
class Dashboard_model extends CI_Model {
	...
	{
		return $this->db->order_by('schoolYearStart', 'DESC')->get('schoolyear')->result_array();
	}

	function setSchoolYear( $id ) {
		$this->db->where( 'isSet', 1 )->update( 'schoolyear', array( 'isSet' => 0 ) );
		return $this->db->where( 'schoolYearID', $id )->update( 'schoolyear', array( 'isSet' => 1 ) );
	}
