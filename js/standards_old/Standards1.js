		...
		return Ext.create('Ext.grid.column.Column',{
			...
			,listeners: {
				click: function( grid, params1, row, params2, params3, rec ){
					...
					// console.warn( parseInt( rec.data.selected, 10 )  )
					// console.warn( active  )
	...
	*/
	...
	function _formPanel( params ){
										...
										,{
											...
											,handler:	function(){
												...
												if( typeof params.customResetHandler != 'undefined' ){
													...
													Ext.getCmp( 'barangayID' + params.module ).setReadOnly( true );
		...
		return {
			...
			,minHeight:		( typeof params.minHeight != 'undefined' )? params.minHeight : 500
			,route: 		params.route
	...
	*/
	...
	function _gridPanel( params ){
		...
		if( typeof params.tbar != 'undefined' ){
			...
			if( typeof params.tbar == 'string' ){
				...
				if( me.content instanceof Array ){
					...
					if( typeof me.extraTbar1 != 'undefined' ){
						for( var x in me.extraTbar1 ){
							console.warn( params.extraTbar1 );
							tbarItems.push( me.extraTbar1[x] );
						}
					}
					...
					console.warn( noExcel )
					console.warn( canPrint )
					if( canPrint ){
						if( !noExcel ){
							tbarItems.push( 
								{	xtype:		'button'
		...
		return Ext.create('Ext.grid.Panel', {
			id				: params.id
			// ,autoScroll		: ( typeof params.autoScroll != 'undefined' )? params.autoScroll : true
			,store			: store
			,hidden			: params.hidden
