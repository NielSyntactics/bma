var standards = function(){
	...
	*/
	...
	function _createButton(params) {
		var text        = (typeof params.text != 'undefined') ? params.text : '';
		var iconCls     = (typeof params.iconCls != 'undefined') ? params.iconCls : '';
		var tooltip     = (typeof params.tooltip != 'undefined') ? params.tooltip : '';
		var disabled    = (typeof params.disabled != 'undefined') ? params.disabled : false;
		var hidden      = (typeof params.hidden != 'undefined') ? params.hidden : false;
		var style       = (typeof params.style != 'undefined') ? params.style : '';
		var width       = (typeof params.width != 'undefined') ? params.width : null;
		var handler     = (typeof params.handler != 'undefined') ? params.handler : null;
		var listeners   = (typeof params.listeners != 'undefined') ? params.listeners : null;
		...
		return Ext.create('Ext.button.Button', {
			...
			handler    : handler,
			listeners  : listeners,
			enableToggle: (typeof params.enableToggle != 'undefined') ? params.enableToggle : false,
			pressed    : (typeof params.pressed != 'undefined') ? params.pressed : false,
			scale      : (typeof params.scale != 'undefined') ? params.scale : 'small',
			menu       : (typeof params.menu != 'undefined') ? params.menu : null,
			cls        : (typeof params.cls != 'undefined') ? params.cls : null
		});
	}
	...
	*/
	...
	function _createNumberField( params ){
		...
		var field = Ext.create('widget.numericfield',{
						...
						,allowNull			: ( typeof params.allowNull != 'undefined' )? params.allowNull : false
						,allowNegative	: ( typeof params.allowNegative != 'undefined' )? params.allowNegative : true
					});
